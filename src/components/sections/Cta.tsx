...
import { ArrowRight, Sparkles, Heart, Shield, Gift } from 'lucide-react';

export default function CTA() {
  const stats = [
    { value: '15K+', label: 'Happy Customers', icon: Heart },
    { value: '100%', label: 'Handcrafted', icon: Sparkles },
    { value: '25+', label: 'Years Experience', icon: Shield },
    { value: '500+', label: 'Unique Designs', icon: Gift },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each piece tells a story of passion, artistry, and timeless elegance. Find jewelry
                as unique as you are, crafted with love and attention to every detail.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Gift Wrapping</h3>
              <p className="text-sm text-muted-foreground">
                Elegant packaging for every special moment
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Quality guarantee on all handcrafted pieces
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Custom engraving and personalization available
              </p>
            </div>
          </div>
        </div>
